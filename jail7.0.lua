-- ExpensiveMods Jailbreak Cheat (Optimized)
...
if TabsContainer:FindFirstChildOfClass("TextButton") then
    TabsContainer:FindFirstChildOfClass("TextButton"):MouseButton1Click()
end
...
-- Запускаем циклы
flyConn = RunService.Heartbeat:Connect(FlyUpdate)
noclipConn = RunService.Stepped:Connect(NoclipUpdate)
arrestConn = RunService.Heartbeat:Connect(AutoArrestUpdate)
