...
local KeyAuthConfig = {
    name = "ruztsoft",          -- Имя вашего приложения в KeyAuth
    ownerid = "Q2uvPey1OB",        -- Ваш Owner ID из KeyAuth
    secret = "217bed44eac9e5ac571c511296c651c786c962448b16c9ca7b49d91f86270ee6",       -- Ваш Secret Key из KeyAuth  
    version = "1.0",
...
-- Wrapper function to load your cheat after license verification
local function LoadExpensiveMods()
    ...
    -- YOUR ORIGINAL CODE STARTS HERE (весь ваш предыдущий код)
...
-- Player Management (ИСПРАВЛЕННЫЙ КОД ДЛЯ ВСЕХ ИГРОКОВ)
local function InitializePlayers()
    ...
    Players.PlayerAdded:Connect(function(player)
        ...
        -- Track character respawns for this player
    ...
    -- Track character changes for existing players
    for _, player in pairs(Players:GetPlayers()) do
        if player ~= LocalPlayer then
            player.CharacterAdded:Connect(function()
                wait(1)
...
print("ExpensiveMods fully loaded! ESP works for all players including respawned ones.")
...
print("ExpensiveMods fully loaded with KeyAuth protection!")
end
